/* RPCServer.cpp : This file contains the 'main' function. Program execution
 * begins and ends there. This is a very very simple example of a CPSC5042
 * Server that will listen to a CPSC5042 Client server, then run the various
 * RPC's that might happen between the server and client
 *
 ...
 *      - This initial server will handle 3 RPC's:
 *          - Connect
